...
var loaderController = Get.put(LoadingController());
...
class LoadingController extends GetxController {
  ...
  showErrorMsg(String msg) {
    EasyLoading.showError(msg, duration: const Duration(seconds: 5));
    update();
  }

  showSuccess(String msg) {
    EasyLoading.showSuccess(msg, duration: const Duration(seconds: 5));
    update();
  }
}
